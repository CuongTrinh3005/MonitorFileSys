...
from ....utils.feature_flags import is_fflag_enabled, CONTRACT_MODULE_SUPPORT
...
def types_registry():
    ...
    # TODO (TM-39490) Add SATs to ensure this is working
    if is_fflag_enabled(feature_flag=CONTRACT_MODULE_SUPPORT):
