...
class TransactionCode:
    def __init__(self, *, domain, family, subfamily, _from_proto=False):
        ...
        if missing:
            raise TypeError(
                f'TransactionCode missing required argument(s): {missing}'
            )
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ClassSpec(
            ...
            docstring='''
                ...
                For further information, see the [Postings API reference](/reference/postings_api/key_components/#posting_instruction).
...
class PostingInstruction(postings360.PostingInstruction):
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        super_spec.public_methods['balances'].docstring = '''
