...
from ..types import (
    Balance, PostingInstruction, PostingInstructionType, defaultAddress, defaultAsset, NumberKind,
    Phase, Tside, Level, Features, NoteType, RejectedReason, UpdatePermission, Parameter,
    NumberShape, StringShape, AccountIdShape, DenominationShape, DateShape, ClientTransaction,
    ClientTransactionEffects, ClientTransactionEffectsDefaultDict, BalanceDefaultDict,
    BalanceTimeseries, FlagTimeseries, ParameterTimeseries, PostingInstructionBatch
)
from .....utils.symbols import DEFAULT_V3_ADDRESS, DEFAULT_V3_ASSET
...
class PublicCommonV300TypesTestCase:
    ...
    def test_client_transaction_effect_missing_denomination(self):
        ...
        with self.assertRaises(StrongTypingError):
            ClientTransactionEffectsDefaultDict(mapping={
        ...
        posting_instruction_batch = PostingInstructionBatch(
            ...
            posting_instructions=[
                PostingInstruction(
                    ...
                    denomination='GBP',
                    account_id=self.account_id_300,
                    account_address=DEFAULT_V3_ADDRESS,
                    asset=DEFAULT_V3_ASSET,
