...
class Rejected(utils_exceptions.Rejected):
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ExceptionSpec(
            name='Rejected',
            docstring=(
                'An Exception raised by the [pre_posting_code](/reference/contracts/apis/smart_contracts_api_reference3XX/hooks/#pre_posting_code) '  # noqa: E501
                'hook to reject a [PostingInstruction](#classes-PostingInstruction).'
            ),
            constructor_args=[
