...
class VaultFunctionsABC(types_utils.StrictInterface):
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        localize_datetime_spec = types_utils.MethodSpec(
            ...
            args=[
                types_utils.ValueSpec(
                    name='dt',
                    type='datetime',
                    docstring='The datetime to localize'
                )
            ],
            return_value=types_utils.ReturnValueSpec(
                type='datetime',
                docstring='The localized datetime'
            ),
            examples=[
                types_utils.Example(
        ...
        spec.public_attributes['plan_id'] = types_utils.ValueSpec(
            name='plan_id',
            type='str',
            docstring='The ID of the Plan currently being executed.'
        )
        spec.public_attributes['supervisees'] = types_utils.ValueSpec(
            ...
            docstring="""
                ...
                [here](/reference/contracts/apis/smart_contracts_api_reference3XX/hooks/).
            """
        )
        ...
        spec.public_methods['get_plan_creation_date'] = types_utils.MethodSpec(
            ...
            args=[],
            return_value=types_utils.ReturnValueSpec(
                docstring='The date the Plan was created.',
                type='datetime'
            )
        )
        return spec
