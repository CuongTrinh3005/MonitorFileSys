...
class VaultFunctionsABC(v320_lib.VaultFunctionsABC):
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        spec.public_methods['amend_schedule'].docstring = '''
            ...
            See [execution_schedules](../hooks/#execution_schedules) for information on schedules.
            In versions 3.3+, amending schedules that belong to event type group is not allowed.
        '''
        spec.public_methods['remove_schedule'].docstring = '''
