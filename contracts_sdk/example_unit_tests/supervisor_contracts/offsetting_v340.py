...
@requires(
    ...
    data_scope='all', parameters=True, balances='latest live',
...
def scheduled_code(event_type, effective_date):
    ...
    if savings_balance > mortgage_balance:
        ...
        supervisee_pib = supervisee.make_internal_transfer_instructions(
            amount=interest_amount, asset=DEFAULT_ASSET, denomination=_DENOMINATION,
...
def _get_effective_balance(balances):
    ...
    # calculations.
    return balances[
               DEFAULT_ADDRESS, DEFAULT_ASSET, _DENOMINATION, Phase.COMMITTED
           ].net + balances[
               DEFAULT_ADDRESS, DEFAULT_ASSET, _DENOMINATION, Phase.PENDING_OUT
           ].net
