    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        spec.public_methods['get_hook_directives'] = types_utils.MethodSpec(
            ...
            docstring="""
                ...
                [HookDirectives](../../supervisor_contracts_api_reference3XX/types/#classes-HookDirectives).
                Available on Supervisor Contract versions 3.4.0+ for use on the Supervisees
                [Vault](../vault/) object only. It cannot be used on a non-supervised Vault object.
            """,
            args=[],
        ...
        spec.public_methods['get_alias'] = types_utils.MethodSpec(
            name='get_alias',
            docstring="""
                Returns the alias value set for the the Smart Contract Version in the Supervisor
                [SmartContractDescriptor]
                (../../supervisor_contracts_api_reference3XX/types/#classes-SmartContractDescriptor)
                object. Available on Supervisor Contract versions 3.4.0+ for use on the Supervisees
                [Vault](../vault/) object only. It cannot be used on a non-supervised Vault object.
            """,
            args=[],
            return_value=types_utils.ReturnValueSpec(
                docstring='The Supervisee Smart Contract Version alias.',
                type='str'
            )
        )
