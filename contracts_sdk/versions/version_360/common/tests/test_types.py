...
from ..types import (
    Phase, Balance, BalanceDefaultDict, BalanceTimeseries,
    PostingInstruction, PostingInstructionBatch, ClientTransaction,
    defaultAddress, defaultAsset, HookDirectives, AddAccountNoteDirective,
    AmendScheduleDirective, RemoveSchedulesDirective, NoteType,
    WorkflowStartDirective, PostingInstructionBatchDirective,
...
class PublicCommonV360TypesTestCase(PublicCommonV350TypesTestCase):
    ...
    def test_balance_dict_aggregation_iadd(self):
        ...
        self.assertDictEqual(
            expected_aggregated_balance_default_dict,
            aggregated_balance_default_dict
        )
    ...
    def test_balance_aggregation_radd(self):
        ...
        self.assertEqual(
            Balance(credit=Decimal(60), debit=Decimal(60), net=Decimal(0)),
            aggregated_balance
        )
