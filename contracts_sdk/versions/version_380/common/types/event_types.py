...
class EventTypeSchedule:
    ...
    def __init__(
        self, *, day=None, day_of_week=None, hour=None, minute=None, second=None, month=None,
        year=None, _from_proto=False
    ):

        if not _from_proto:
            if not any([day, day_of_week, hour, minute, second, month, year]):
                raise StrongTypingError('Empty EventTypeSchedule object created')
    ...
    def _public_attributes(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return [
            types_utils.ValueSpec(
                name='day',
                type='Optional[str]',
                docstring='Day of the month (1-31).'
            ),
            types_utils.ValueSpec(
                name='day_of_week',
                type='Optional[str]',
            ...
            types_utils.ValueSpec(
                name='minute',
                type='Optional[str]',
                docstring='Minute (0-59).'
            ),
            types_utils.ValueSpec(
                name='second',
                type='Optional[str]',
                docstring='Second (0-59).'
            ),
            types_utils.ValueSpec(
                name='month',
                type='Optional[str]',
                docstring='Month (1-12).'
            ),
            types_utils.ValueSpec(
                name='year',
                type='Optional[str]',
                docstring='Year (4-digit year).'
            ),
        ]
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ClassSpec(
            ...
            docstring=(
                ...
                '[Smart](/reference/contracts/apis/smart_contracts_api_reference3XX/metadata/'
                '#events_timezone) and [Supervisor](/reference/contracts/apis/'
                'supervisor_contracts_api_reference3XX/metadata/#events_timezone) Contract '
