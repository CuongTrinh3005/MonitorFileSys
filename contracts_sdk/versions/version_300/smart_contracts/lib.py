...
class VaultFunctionsABC(types_utils.StrictInterface):
    ...
    def make_internal_transfer_instructions(
        self, *, amount, denomination, client_transaction_id,
        from_account_id, from_account_address=None,
        to_account_id, to_account_address=None,
        pics=None, instruction_details=None, asset=symbols.DEFAULT_V3_ASSET,
    ...
    def instruct_posting_batch(
        self, *,
        posting_instructions, batch_details=None, client_batch_id=None, effective_date=None,
        request_id=None
    ):
        pass
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        spec = types_utils.ClassSpec(
            ...
            ''',
            public_methods=[types_utils.MethodSpec(
                ...
                return_value=types_utils.ReturnValueSpec(
                    docstring='The last execution time.',
                    type='datetime'
                ),
                examples=[
                    types_utils.Example(
        ...
        public_methods = [
            ...
            types_utils.MethodSpec(
                ...
                docstring='''
                    ...
                    The note will appears in the ops dash, and if *is_visible_to_customer*
            ...
            types_utils.MethodSpec(
                ...
                args=[],
                return_value=types_utils.ReturnValueSpec(
                    docstring='The Account creation date.',
                    type='datetime'
                )
            ),
            types_utils.MethodSpec(
                ...
                args=[],
                return_value=types_utils.ReturnValueSpec(
                    docstring='The timeseries of balances.',
                    type='BalanceTimeseries'
                )
            ),
            types_utils.MethodSpec(
                ...
                args=[],
                return_value=types_utils.ReturnValueSpec(
                    docstring='The unique-enough id.',
                    type='str'
                )
            ),
            types_utils.MethodSpec(
                ...
                return_value=types_utils.ReturnValueSpec(
                    docstring='The timeseries of parameters.',
                    type='ParameterTimeseries'
                )
            ),
            types_utils.MethodSpec(
                ...
                return_value=types_utils.ReturnValueSpec(
                    docstring='The timeseries of flags.',
                    type='FlagTimeseries'
                )
            ),
            types_utils.MethodSpec(
            ...
            types_utils.MethodSpec(
                ...
                args=[
                    types_utils.ValueSpec(
                        name='amount',
                        type='Decimal',
                        docstring='The amount to be transferred.'
                    ),
                    types_utils.ValueSpec(
                        name='denomination',
                        type='str',
                    ...
                    types_utils.ValueSpec(
                        name='to_account_id',
                        type='str',
                        docstring='The Account id to be credited.'
                    ),
                    types_utils.ValueSpec(
                ...
                args=[
                    ...
                    types_utils.ValueSpec(
                        ...
                        docstring='''
                            ...
                            If not specified, defaults to `datetime.utcnow()`.
                        '''
                    ),
                    types_utils.ValueSpec(
                        name='request_id',
