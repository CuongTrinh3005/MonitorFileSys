...
from ..types import (
    defaultAddress, defaultAsset, PostingInstruction, PostingInstructionType,
    PostingInstructionBatch, Phase, StringShape, Parameter, ClientTransaction,
    OptionalValue
)
...
from .....utils.symbols import ContractParameterLevel, DEFAULT_V3_ADDRESS, DEFAULT_V3_ASSET
...
class PublicCommonV320TypesTestCase(PublicCommonV310TypesTestCase):
    ...
    def test_parameter_cannot_use_optional_default_value(self):
        ...
        self.assertIn(
            f'Non optional shapes must have a non optional default value: overdraft_limit',
            str(ex.exception)
        )
    ...
    def test_derived_parameters_cannot_have_default_values(self):
        ...
        self.assertIn(
            f'Derived Parameters cannot have a default value or update permissions: '
            f'overdraft_limit',
            str(ex.exception)
        )
