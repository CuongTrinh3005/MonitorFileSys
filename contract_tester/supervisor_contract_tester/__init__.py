...
def run(supervisor_contract_code: str, function_name: str, vault: Mock, *args, **kwargs):
    ...
    Args:
        ...
        vault: The mock Vault object to make available to the function being run. Will only be
            available for hook functions.
