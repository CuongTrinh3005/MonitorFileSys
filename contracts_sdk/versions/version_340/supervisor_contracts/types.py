...
from ..common.types import (
    Balance, BalanceDefaultDict, BalanceTimeseries, defaultAddress, defaultAsset, Level, Features,
    NoteType, NumberKind, Phase, PostingInstructionType, RejectedReason, Tside, UpdatePermission,
    InvalidContractParameter, Rejected, FlagTimeseries, calendarObject, datetimeObject,
    decimalObject, defaultDict, mathObject, jsonDumpsObject, jsonLoadsObject, parseToDatetimeObject,
    roundFloorObject, roundHalfDownObject, roundHalfUpObject, timedeltaObject, OptionalValue,
    ParameterTimeseries, UnionItem, UnionItemValue, ClientTransaction, ClientTransactionEffects,
    ClientTransactionEffectsDefaultDict, AddressDetails, AccountIdShape, DateShape,
    DenominationShape, NumberShape, OptionalShape, StringShape, UnionShape, Parameter,
    PostingInstruction, PostingInstructionBatch, transaction_reference_field_name, ROUND_CEILING,
    ROUND_DOWN, ROUND_HALF_EVEN, ROUND_05UP, EventTypesGroup, AddAccountNoteDirective,
    AmendScheduleDirective, HookDirectives, PostingInstructionBatchDirective,
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ClassSpec(
            ...
            docstring='''
                    ...
                    [execution_schedules](../hooks/#execution_schedules) hook in the `event_types`
                    list. **Only available in version 3.4.0+**.
                ''',
            public_attributes=cls._public_attributes(language_code),
            constructor=types_utils.ConstructorSpec(
                docstring='Constructs a new EventType',
        ...
        return [
            types_utils.ValueSpec(
                ...
                docstring='''
                    ...
                    the name defined in the [execution_schedules](../hooks/#execution_schedules)
                    hook.
                '''
            ),
            types_utils.ValueSpec(
