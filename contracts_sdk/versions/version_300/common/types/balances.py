    ...
    def _public_attributes(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return [
            types_utils.ValueSpec(
                name='credit',
                type='Decimal',
                docstring='The total credit balance'
            ),
            types_utils.ValueSpec(
                name='debit',
                type='Decimal',
                docstring='The total debit balance'
            ),
            types_utils.ValueSpec(
                name='net',
                type='Decimal',
...
class BalanceTimeseries(types_utils.Timeseries(BALANCE_ITEM_TYPE, 'Balance dictionary')):
    return_on_empty = lambda *_: BalanceDefaultDict(lambda *_: Balance())
